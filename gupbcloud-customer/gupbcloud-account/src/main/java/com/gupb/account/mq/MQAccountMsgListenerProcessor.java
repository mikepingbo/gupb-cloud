...
@Component
public class MQAccountMsgListenerProcessor implements MessageListenerConcurrently{

    private static final Logger logger = LoggerFactory.getLogger(MQAccountMsgListenerProcessor.class);
