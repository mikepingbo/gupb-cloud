...
public class MQAccountConfiguration {
    public static final Logger LOGGER = LoggerFactory.getLogger(MQAccountConfiguration.class);
    ...
    @Autowired
    private MQAccountMsgListenerProcessor mqMessageListenerProcessor;
