...
public class MQInventoryConfiguration {
    public static final Logger LOGGER = LoggerFactory.getLogger(MQInventoryConfiguration.class);
    ...
    @Autowired
    private MQInventoryMsgListenerProcessor mqMessageListenerProcessor;
